...
public class Generator {
    ...
    public static void main(String[] args) {
        ...
        dataSourceConfig.setUrl("jdbc:mysql://localhost:3306/sql_practice?characterEncoding=utf-8&serverTimezone=GMT%2B8&useSSL=false");
        ...
        strategy.setInclude(scanner("student").split(","));
